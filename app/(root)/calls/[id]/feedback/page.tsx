	...
	return (
		<div
			...
			<div className="absolute flex flex-col items-center leading-none">
				<span className="text-[20px] font-bold text-zinc-900 dark:text-zinc-50">
					{label}
				</span>
...
function TranscriptSection({
	...
	return (
		<details className="group rounded-2xl overflow-hidden bg-white dark:bg-zinc-900 ring-1 ring-black/6 dark:ring-white/6">
			...
			<div
				className="border-t border-black/5 dark:border-white/5 p-4 flex flex-col gap-2.5 max-h-80 overflow-y-auto"
...
const FeedbackPage = async ({
	...
	const card =
		"rounded-2xl p-5 bg-white dark:bg-zinc-900 ring-1 ring-black/[0.06] dark:ring-white/[0.06]";
		...
		<main className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
			...
			<div className="max-w-6xl mx-auto px-4 py-20 flex flex-col gap-4">
				...
				{feedback ? (
								...
								<ul className="flex flex-col gap-3">
									{feedback.strengths.map((s, i) => (
										<li key={i} className="flex items-start gap-2.5">
											...
											<span className="text-[13px] text-zinc-600 dark:text-zinc-300 leading-snug">
												{s}
											</span>
										</li>
									))}
					...
					<div
						className={cn(card, "text-center text-[13px] text-zinc-400 py-12")}>
